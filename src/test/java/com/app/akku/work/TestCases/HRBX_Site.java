...
public class HRBX_Site {
	...
	@BeforeTest
	@Parameters({ "platform", "browser", "Environment" })
	public void setup(String platform, String browser, String Environment) throws Exception {
		...
		public void HRBX_COM() throws Exception {
			...
			eyes.checkWindow("HornbillFX Site After 2 Sec");
			
			Thread.sleep(2000);
			
			eyes.checkWindow("HornbillFX Site After 4 Sec");
			
			Thread.sleep(2000);
			
			eyes.checkWindow("HornbillFX Site After 6 Sec");
